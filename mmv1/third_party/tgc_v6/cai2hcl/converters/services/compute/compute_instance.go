...
func (c *ComputeInstanceConverter) convertResourceData(asset *caiasset.Asset) (*models.TerraformResourceBlock, error) {
	...
	// hclData["machine_type"] = utils.ParseFieldValue(instance.MachineType, "machineTypes")
	...
	// } else {
	// 	hclData["zone"] = utils.ParseFieldValue(instance.Zone, "zones")
	// }
	...
	hclData["labels"] = utils.RemoveAttributionLabel(instance.Labels)
